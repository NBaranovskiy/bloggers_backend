...
createBlogHandler_1.createBlogHandler)
    ...
    .post('/:blogId/posts', super_admin_guard_middleware_1.superAdminGuardMiddleware, PostInputDtoValidation_1.postInputValidation, BlogInputDtoValidation_1.handleValidationErrors, // <--- ДОБАВЛЕНО: Обработка ошибок валидации для POST /blogs/:blogId/posts
createPostForBlogHandler_1.createPostForBlogHandler)
